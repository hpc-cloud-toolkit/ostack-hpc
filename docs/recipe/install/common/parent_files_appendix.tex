...
% ohpc_command # # compute node settings, are in independent files
% ohpc_command # # -------------------------
% ohpc_command ohpc_pkg="${ohpc_pkg:-https://github.com/openhpc/ohpc/releases/download/v1.2.1.GA/ohpc-release-centos7.2-1.2-1.x86_64.rpm}"
% ohpc_command #
% ohpc_command 
% ohpc_command 
...
% ohpc_command 
% ohpc_command # HPC slurm partition that needs to be extended. Specified by the admin
