...
% end_ohpc_run
	...
	To install ohpc packages on an image, we need to export the ohpc package (variable "ohpc\_pkg") to DIB. "ohpc\_pkg" is one of the input parameters to be setup by the user in an "input.local" file as described in section "Inputs" of this document.
