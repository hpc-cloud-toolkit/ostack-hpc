	Create an empty chpc\_init file and open for editing. You can also use an existing template and modify- templates are provided if you've installed from the RPM at {\em /opt/ohpc/pub/doc/recipes/centos7/x86\_64/openstack/slurm/cloud\_hpc\_init/ohpc}
