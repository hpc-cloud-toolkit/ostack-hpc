	This section we will create generic configuration, required for baremetal provisioning. We will use ironic as a provisioner and nova as a scheduler. {\em Note: if you already have this configured, skip ahead to the next chapter. }
