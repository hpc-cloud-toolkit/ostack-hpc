...
% ohpc_command validation_comment  
...
% ohpc_command ==========================
% ohpc_command This script perform the post boot configuration including updating SLURM 
% ohpc_command resource manager at sms node for hpc compute nodes
% ohpc_command 
